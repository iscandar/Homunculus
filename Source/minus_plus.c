...
{
	/*files names*/
    char brain_setting[]="example/brain_created/brain_minus_plus.data";
    char dataset[]="example/dataset/minus_plus.data";
    char new_dataset[]="example/dataset_normalized/minus_plus.data";
