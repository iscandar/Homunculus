...
{
	/*files names*/
    char brain_setting[]="example/brain_created/brain_and.data";
    char dataset[]="example/dataset/and.data";
    char new_dataset[]="example/dataset_normalized/and.data";
    ...
    ** learning rate, momentum, error accepted,epoche)*/
    ...
    printf("\nrandom result waited 0 and is %lf \n test finish.", revers_normale);
