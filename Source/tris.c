...
{
	/*files names*/
    char brain_setting[]="example/brain_created/brain_tris.data";
    char dataset[]="example/dataset/tris.data";
    char new_dataset[]="example/dataset_normalized/tris.data";
    ...
    ** learning rate, momentum, error accepted,epoche)*/
    run_training(brain,new_dataset,brain_setting,0.8,0.3,0.001,100000);
    /*liberate memory*/
